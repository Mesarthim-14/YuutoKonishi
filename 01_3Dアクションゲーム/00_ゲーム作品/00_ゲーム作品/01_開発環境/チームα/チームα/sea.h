...
// マクロ定義
//=============================================================================
#define SEA_WIDTH				(4)			// 分割数
#define SEA_HEIGHT				(4)			// 分割数
#define SEA_WIDTH_SIZE			(50000.0f)	// 海のサイズ
#define SEA_HEIGHT_SIZE			(50000.0f)	// 海のサイズ
#define SEA_HEIGHT_POS_Y		(-500.0f)	// 高さの設定
