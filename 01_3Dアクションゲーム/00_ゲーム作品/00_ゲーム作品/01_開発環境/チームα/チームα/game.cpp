...
// マクロ定義
//=======================================================================================
#define MAX_ROUND_NUM		(2)			// ラウンドの数

//=======================================================================================
// static初期化
//=======================================================================================
CCamera *CGame::m_apCamera[MAX_PLAYER] = {};
CLight *CGame::m_pLight = NULL;
CMeshField *CGame::m_pMeshField = NULL;
CMeshShape *CGame::m_pSphere = NULL;
CBg *CGame::m_pBg = NULL;
CPlayer *CGame::m_apPlayer[MAX_PLAYER] = {};
...
void CGame::SetGame(void)
{
	...
	for (int nCount = 0; nCount < MAX_PLAYER; nCount++)
	{
		...
		if (bEnd == true)
		{
			...
			// 勝利数が一定以下なら
			if (m_aWinNum[0] < MAX_ROUND_NUM && m_aWinNum[1] < MAX_ROUND_NUM)
			{
				// ラウンドを進める
				m_nRoundNum++;
