...
#define BEAM_FOLLOW_DISTANCE		(920.0f)	// 追従する距離
#define BOMB_FOLLOW_DISTANCE		(500.0f)	// 追従する距離
#define LASER_FOLLOW_DISTANCE		(500.0f)	// 追従する距離
#define MISSILE_FOLLOW_DISTANCE		(900.0f)	// 追従する距離
...
void CBullet2::SetMove(D3DXVECTOR3 move)
{
	...
	else
	{
		...
		case BULLET2_USER_PL1:
			//カメラ角度取得
			fAngle = CGame::GetCamera(0)->Getφ();
			break;

		case BULLET2_USER_PL2:
			//カメラ角度取得
			fAngle = CGame::GetCamera(1)->Getφ();
			break;
		}
