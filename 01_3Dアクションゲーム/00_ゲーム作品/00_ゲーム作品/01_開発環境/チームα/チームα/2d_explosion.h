...
// マクロ定義
//=====================================================
#define EXPLOSION_SIZE_X_2D		(300)		// 爆発のサイズ
#define EXPLOSION_SIZE_Y_2D		(300)		// 爆発のサイズ
#define EXPLOSION_SIZE_Z_2D		(300)		// 爆発のサイズ
...
public:
	...
	static C2dExplosion *Create(D3DXVECTOR3 pos, D3DXVECTOR3 size);		// クリエイト処理
